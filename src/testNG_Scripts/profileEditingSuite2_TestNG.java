...
public class profileEditingSuite2_TestNG {
	...
	PC_App_Profile profile;
	 ...
	 @Test
	  /*Test Script - Verify user is able to change name and the image for a particular cell in the Pic Grid*/
	  ...
	  @Test
	  /*Test Script - Verify user is able to change name and the image for a particular cell in the Pic Grid and save it*/
